...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      //  TOAST SUCCESS (NO POPUP)
      toast.success("Registered successfully");

      // redirect after slight delay (nice UX)
      setTimeout(() => {
        router.push("/login");
      }, 1500);
      ...
      <div className="relative z-10 w-full flex items-center justify-end pr-[12%]">
        <div className="w-full max-w-md px-6">
          <form
            ...
            className="bg-white/80 backdrop-blur-2xl border border-white/40 rounded-3xl shadow-2xl p-8 space-y-5"
          >
            {/* HEADER */}
            ...
            <div>
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-10 py-3 rounded-xl border border-gray-200 focus:ring-2 focus:ring-blue-500 outline-none"
                />
                <button
                  type="button"
